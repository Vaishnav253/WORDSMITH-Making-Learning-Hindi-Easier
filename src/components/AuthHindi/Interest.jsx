        ...
        <div style={{ height: "100%" }}>
            ...
            <div style={{ paddingTop: "200px" }}>
                ...
                <div className={style.interest_box}>
                    <div className="my-5">इससे पहले कि हम <span style={{ color: "#00C1A2" }}>जारी रखें</span>, हमें अपनी रुचियों के बारे में कुछ बताएं....</div>
                    ...
                    <div className="text-right">
                        <button onClick={storeTopic} style={{ color: "#039982", padding: "5px 15px 5px 15px", borderRadius: "10px", border: "2px solid #039982", fontWeight: "bold" }}>अगला</button>
                    </div>
                </div>
